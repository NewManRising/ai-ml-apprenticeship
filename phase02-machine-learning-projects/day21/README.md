...
In the coming days I will see if I can improve performance including hyperparameters, GridSearchCV, handling class imbalance, and other tuning. None of the models are handling the class imbalance well accoing to their average F1 scores. 