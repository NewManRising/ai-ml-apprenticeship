...
I computed the same metrics like classification report and confusion matrix for both models. Upon viewing the results, the decision tree does a slightly better job than the logistic regression model.
